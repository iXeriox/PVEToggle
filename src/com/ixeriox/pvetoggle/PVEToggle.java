...
public class PVEToggle extends JavaPlugin {
	...
	public boolean checkWorld( String World ) {
		boolean re = false;
		if(this.check_status("PVEToggle.worlds") != false){
			if(this.check_status("PVEToggle.worlds."+World) != false) {
					if(this.check_status("PVEToggle.worlds."+World+".disabled") != false) {
							re = true;
					}
			}
		}
    ...
    public boolean checkEnabled( String name ) {
    	if(this.getConfig().getString("PVEToggle.users."+name+".status") != null){
    	    	if(this.getConfig().getString("PVEToggle.users."+name+".status") == "on") {
    	    		return true;
    	    	}
    	}
    	return false;
